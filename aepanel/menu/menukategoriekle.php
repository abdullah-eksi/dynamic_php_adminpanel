        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo AEURL; ?>/menukategorilistele">Menu Kategorileri</a></li>
                              <li class="breadcrumb-item"><a href="<?php echo AEURL; ?>/menukategoriekle">Menu Kategori Ekle</a></li>
                            </ol>
                        </div>
              ...
              <div class="col-xl-12">
                              <div class="card">
                                  <div class="card-body">
                                      <h4 class="card-title mb-4">Menuler Kategori Ekle</h4>
                                          ...
                                          <div class="row justify-content">
                                              <div class="col-sm-10">
                                                  ...
                                                  <div style="float:right">
                                                      <button type="submit" name="menukatekle" class="btn btn-primary w-md">Yeni Ekle</button>
                                                  </div>
