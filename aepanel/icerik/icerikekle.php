    ...
    <div class="page-content">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                              <li class="breadcrumb-item"><a href="<?php echo AEURL; ?>">Anasayfa </a></li>
                                ...
                                <li class="breadcrumb-item active"><?php echo $tablo_baslik; ?> Ekle</li>
                            </ol>
                        </div>
            ...
            <div class="col-xl-12">
                                          <div class="card">
                                              <div class="card-body">
                                                  ...
                                                  <h4 class="card-title"><?php echo $tablo_baslik; ?> Ekle</h4>
                                                  ...
                                                  <div class="tab-content p-3 text-muted">
                                                      <div class="tab-pane active" id="genel" role="tabpanel">
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col-sm-8">
                                                            <input type="text" class="form-control" required="required"  name="sekilbaslik"  placeholder="Başlık">
                                                      ...
                                                      <div class="row mb-4">
                                                          ...
                                                          <div class="col-sm-8">
                                                          <input type="text" class="form-control"   name="keywords"  placeholder=" Meta Anahtar Kelime">
                                                        ...
                                                        <div style="float:right">
                                                          <button type="submit" name="icerikekle" class="btn btn-primary w-md">Yeni Ekle</button>
                                                        </div>
                                                          </div>
      <br><br>
      <br>
      ...
      <div class="container">
                                              ...
                                              $sayi=0;
                                                        ...
                                                        $degisken =  vericek("degiskenler","where tablo_id=$tablo_id","COK");

                                                        foreach ($degisken as $degiskencek) {
                                                       ...
                                                       <div class="row mb-4">
                                                         ...
                                                         <div class="col-sm-8">
                                                           <input type="text" class="form-control"  name="<?php echo $degiskencek["degisken_adi"]; ?>"  placeholder="<?php echo $degiskencek["degiskenbaslik"]; ?> giriniz">

                                                         </div>
                                                       </div>

                                                     <?php } if($degiskentype==1) {?>

                                                       <div class="row mb-4">
                                                         <label for="horizontal-firstname-input" class="col-sm-2 col-form-label"><?php echo $degiskencek["degiskenbaslik"]; ?></label>
                                                         <div  class="col-sm-8">
                                                         <textarea class="ckeditor" style="height:500px" name="<?php echo $degiskencek["degisken_adi"]; ?>" ></textarea>
